...
public class PublicForumActivity extends AppCompatActivity implements OnCustomItemClicListener{
    ...
    private AdapterPublicforum adapterConnectTeacherList;
    ...
    private void setData() {
        ...
        adapterConnectTeacherList = new AdapterPublicforum(context, this, arrayList);
