 ...
 */
public class AdapterPaymentHistory extends RecyclerView.Adapter<AdapterPaymentHistory.CustomViewHolder> {
    ...
    public AdapterPaymentHistory(Context context, OnCustomItemClicListener lis, ArrayList<ModelTimeTable> list, ArrayList<String> periodName, ArrayList<String> daysList) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int position) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_payment_history, viewGroup, false);
    ...
    public void onBindViewHolder(CustomViewHolder holder, final int position) {
        ...
        if (position == 0) {
            ...
            holder.text_periodname.setText("10/4/2017");
            holder.text_marks_week1.setText("10,000");
            holder.text_marks_week2.setText("Paid");
        }
    ...
    public class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView text_periodname, text_marks_week1, text_marks_week2;
