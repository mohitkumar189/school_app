 ...
 */
public class AdapterTeacherDashbooard extends RecyclerView.Adapter<AdapterTeacherDashbooard.CustomViewHolder> {
    ...
    public AdapterTeacherDashbooard(Context context, OnCustomItemClicListener lis, ArrayList<ModelData> list, Integer[] imgaes) {
